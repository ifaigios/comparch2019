...
SCRIPT="./build/ARM/gem5.opt -d "$1"_results/l1i-"$L1I_SIZE"-"$L1I_ASSOC"__l1d-"$L1D_SIZE"-"$L1D_ASSOC"__l2-"$L2_SIZE"-"$L2_ASSOC"__lines-"$CACHELINE_SIZE" configs/example/se.py --cpu-type=MinorCPU --caches --l2cache -I 100000000 \
--l1i_size=$L1I_SIZE --l1i_assoc=$L1I_ASSOC --l1d_size=$L1D_SIZE --l1d_assoc=$L1D_ASSOC --l2_size=$L2_SIZE --l2_assoc=$L2_ASSOC --cacheline_size=$CACHELINE_SIZE --cpu-clock=$CPU_CLOCK"
